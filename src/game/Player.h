...
class MANGOS_DLL_SPEC Player : public Unit
{
    ...
    public:
        ...
        uint32 CountItemWithLimitCategory(uint32 limitCategory, Item* skipItem = NULL) const;
        ...
        bool IsTitanGripWeapon(ItemPrototype const* proto) const;
        ...
        uint32 LookupRefundable(ObjectGuid itemGUID);
