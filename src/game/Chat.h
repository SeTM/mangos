...
class ChatHandler
{
    ...
    protected:
        ...
        bool HandleMoodSetCommand(char* args);
        bool HandleMoodClearCommand(char* args);
        bool HandleMoodCommand(char* args);
        ...
        bool HandleNpcLinkCommand(char* args);
        ...
        bool HandleReloadNpcLinkCommand(char* args);
