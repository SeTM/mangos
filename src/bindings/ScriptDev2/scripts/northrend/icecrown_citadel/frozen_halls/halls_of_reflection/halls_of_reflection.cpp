...
struct MANGOS_DLL_DECL npc_jaina_and_sylvana_HRextroAI : public npc_escortAI
{
    ...
    void WaypointReached(uint32 i)
    {
        switch(i)
        {
            case 3:
                ...
                if(GameObject* pGate = m_creature->SummonGameObject(GO_ICE_WALL, 5540.39f, 2086.48f, 731.066f, 1.00057f, 0, 0, 0, 0, 0))
                {
   ...
   void Outro()
   {
        switch(Step)
        {
           case 10:
              ...
              break;
           case 11:
                if(GameObject* pCave = m_creature->SummonGameObject(GO_CAVE, 5275.28f, 1694.23f, 786.147f, 0.981225f, 0, 0, 0, 0, 0))
   ...
   void UpdateEscortAI(const uint32 diff)
   {
      ...
      if (WallCast == true && HoldTimer < 10000 && ( m_pInstance->GetData(DATA_SUMMONS) == 0 || !m_creature->isInCombat()))
      {
         ...
         {
            case 2:
              if(GameObject* pGate = m_creature->SummonGameObject(GO_ICE_WALL, 5494.3f, 1978.27f, 736.689f, 1.0885f, 0, 0, 0, 0, 0))
              {
              ...
              break;
            case 3:
              if(GameObject* pGate = m_creature->SummonGameObject(GO_ICE_WALL, 5434.27f, 1881.12f, 751.303f, 0.923328f, 0, 0, 0, 0, 0))
              {
                 if(pLichKing && pLichKing->isAlive())
              ...
              break;
            case 4:
              if(GameObject* pGate = m_creature->SummonGameObject(GO_ICE_WALL, 5323.61f, 1755.85f, 770.305f, 0.784186f, 0, 0, 0, 0, 0))
              {
                 if(pLichKing && pLichKing->isAlive())
