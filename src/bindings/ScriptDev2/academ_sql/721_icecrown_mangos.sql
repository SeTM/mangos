...
DELETE FROM `gameobject` WHERE `guid` = 1324031;
INSERT INTO `gameobject` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `position_x`, `position_y`, `position_z`, `orientation`, `rotation0`, `rotation1`, `rotation2`, `rotation3`, `spawntimesecs`, `animprogress`, `state`) VALUES
(1324031, 202244, 631, 3, 1, -209.5, 2211.91, 199.97, 3.07661, 0, 0, 0.999472, 0.0324833, 0, 0, 1);
...
DELETE FROM `gameobject` WHERE `guid` IN (1324031);
...
DELETE FROM `creature` WHERE `guid` = 991547 AND `id` = 38589;
